...
public class MainActivityTecn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tecn);

        //bottom

        BottomNavigationView bottomNavigationView = (BottomNavigationView)findViewById(R.id.bottomtecn_navigation);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_consulta:
                        Toast.makeText(MainActivityTecn.this, "Go home section...", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_asignar:
                        Toast.makeText(MainActivityTecn.this, "Go share section...", Toast.LENGTH_SHORT).show();
                        break;
        ...
        fullnameText.setText("Tecnico Name ");
